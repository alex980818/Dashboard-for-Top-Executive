    ...
    <?php if ($dateOption=="last7day" || $dateOption=="last30day" ||$dateOption=="last12month"){ ?>
        <div >
            <form method="post">
              ...
              <select name="productOption" onchange="this.form.submit();" style="float: right" action="graph_totalSales.php" method="GET">
       ...
       if($productOption=="productA"||$productOption=="productB"||$productOption=="productC"||$productOption=="productD"){?>
            <!--<div id="chart_div" style="width: 100%; height: 100%;"></div>-->
            <iframe src="graph_totalSalesSub.php" style="width: 100%; height: 100%;"></iframe>
        <?php }else{?>
            <div id="chart" style="width: 100%; height: 100%;"></div>
        <?php }?>
