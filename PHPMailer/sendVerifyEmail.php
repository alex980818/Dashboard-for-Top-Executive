...
if($result-> num_rows>0){
    ...
    $mail->isHTML(true);                                 
    $mail->Subject = 'From Justforlhdb Dashboard. Verify your email';
    $mail->Body    = ' Please use the following link to verify your email: <br/><br/>https://justforlhdb.com/project/verify.php?email='.$email;
    $mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
    
    $mail->send();
    
    echo"Please check ".$email." to verify the email.";
